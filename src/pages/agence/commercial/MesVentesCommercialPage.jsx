...
const MesVentesCommercialPage = () => {
  ...
  const fetchVentes = async () => {
    ...
    setError("");
    try {
      const res = await API.get("/agence/ventes/commercial");
      setVentes(res.data);
    } catch (err) {
    ...
    <PageLayout>
      <Container maxWidth="xl" sx={{ mt: 4, mb: 4 }}>
            ...
            <Box display="flex" alignItems="center" gap={2}>
              ...
              <Box>
                ...
                <Typography variant="body2" color="text.secondary">
                  Suivez l'avancement de vos ventes avec le notaire
                </Typography>
              </Box>
            </Box>
            <Button
        ...
        >
          <DialogTitle>
            <Box display="flex" alignItems="center" justifyContent="space-between">
              <Typography variant="h6">Historique de la vente</Typography>
              <IconButton onClick={() => setHistoriqueOpen(false)}>
                <Close />
              </IconButton>
            </Box>
          </DialogTitle>
...
export default MesVentesCommercialPage;
