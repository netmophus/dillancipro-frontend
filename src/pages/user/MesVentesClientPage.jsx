...
const MesVentesClientPage = () => {
  ...
  const fetchVentes = async () => {
    ...
    setError("");
    try {
      const res = await API.get("/agence/ventes/client");
      setVentes(res.data);
    } catch (err) {
            ...
            <Box display="flex" alignItems="center" gap={2}>
              ...
              <Box>
                ...
                <Typography variant="body2" color="text.secondary">
                  Suivez l'avancement de vos achats avec le notaire
                </Typography>
              </Box>
            </Box>
            <Button
              ...
              <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                  <Card variant="outlined" sx={{ p: 2 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      Téléphone: {selectedVente.commercialId?.phone || "N/A"}
                    </Typography>
                  </Card>
                </Grid>
                    ...
                    {selectedVente.signatures && (
                      <Box mb={2}>
                        ...
                        <Box display="flex" gap={2} flexWrap="wrap">
                          ...
                          />
                          <Chip
                            label={`Vous: ${selectedVente.signatures.client ? "✓ Signé" : "En attente"}`}
...
export default MesVentesClientPage;
